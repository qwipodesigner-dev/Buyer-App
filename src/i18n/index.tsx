...
const STRINGS: Record<LangCode, Record<string, string>> = {
  en: {
    ...
    'account.used': 'Used',
    'account.limit': 'Limit',
    'account.track_orders': 'Track orders',
  ...
  hi: {
    ...
    'account.used': 'उपयोग',
    'account.limit': 'सीमा',
    'account.track_orders': 'ऑर्डर ट्रैक करें',
  ...
  te: {
    ...
    'account.track_orders': 'ఆర్డర్లు ట్రాక్ చేయండి',
  ...
  ta: {
    ...
    'account.track_orders': 'ஆர்டர்களை கண்காணி',
